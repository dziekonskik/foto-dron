...
function displayGallery(e) {
  ...
  const pictures = Array.from(
    displayScreen.querySelectorAll('.works__samples-img')
  );
  ...
  function prevPicture() {
    displayPhoto(
      currentPicture.previousElementSibling || displayScreen.lastElementChild
    );
  }

  function nextPicture() {
    displayPhoto(
      currentPicture.nextElementSibling || displayScreen.firstElementChild
    );
  }
